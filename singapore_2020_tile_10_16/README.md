...
| `RemoteSensing` | 3 | 512x512 | 8-bit RGB derived from Landsat Collect | band 1, band 2, band 3 | 98.2 |
...
```bash
python make_tile_viz.py --tile 10_16 --year 2020
python make_location_map.py --tile 10_16 --year 2020
```
